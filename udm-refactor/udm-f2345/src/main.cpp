...
void handlef1(const Rest::Request& req, Http::ResponseWriter resp){
	...
	handler1.internalf2345(req.body(), response_send);
...
int main(int argc, char* argv[])
{
	...
	Routes::Post(router, "/f2345", Routes::bind(handlef1));

	spdlog::info("Starting HTTP Server for UDM-5GAKA Function: f2345");
