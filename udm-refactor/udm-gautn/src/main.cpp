...
void handle_gautn(const Rest::Request& req, Http::ResponseWriter resp){
	...
	handler1.internal_gautn(req.body(), response_send);
...
int main(int argc, char* argv[])
{
	...
	Routes::Post(router, "/gautn", Routes::bind(handle_gautn));

	spdlog::info("Starting HTTP Server for UDM-5GAKA Function: generate_autn");
